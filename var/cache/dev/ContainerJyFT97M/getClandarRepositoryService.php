 ...
 */
class getClandarRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ClandarRepository' shared autowired service.
     *
     * @return \App\Repository\ClandarRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ClandarRepository.php';

        return $container->privates['App\\Repository\\ClandarRepository'] = new \App\Repository\ClandarRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
