 ...
 */
class getSupplementsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SupplementsRepository' shared autowired service.
     *
     * @return \App\Repository\SupplementsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SupplementsRepository.php';

        return $container->privates['App\\Repository\\SupplementsRepository'] = new \App\Repository\SupplementsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
