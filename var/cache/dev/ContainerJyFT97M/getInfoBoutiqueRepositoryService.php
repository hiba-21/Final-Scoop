 ...
 */
class getInfoBoutiqueRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\InfoBoutiqueRepository' shared autowired service.
     *
     * @return \App\Repository\InfoBoutiqueRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'InfoBoutiqueRepository.php';

        return $container->privates['App\\Repository\\InfoBoutiqueRepository'] = new \App\Repository\InfoBoutiqueRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
