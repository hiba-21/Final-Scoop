 ...
 */
class getPannierRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PannierRepository' shared autowired service.
     *
     * @return \App\Repository\PannierRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PannierRepository.php';

        return $container->privates['App\\Repository\\PannierRepository'] = new \App\Repository\PannierRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
