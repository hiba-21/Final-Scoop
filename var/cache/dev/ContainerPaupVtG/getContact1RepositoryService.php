 ...
 */
class getContact1RepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\Contact1Repository' shared autowired service.
     *
     * @return \App\Repository\Contact1Repository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'Contact1Repository.php';

        return $container->privates['App\\Repository\\Contact1Repository'] = new \App\Repository\Contact1Repository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
