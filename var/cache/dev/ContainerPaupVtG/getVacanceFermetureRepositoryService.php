 ...
 */
class getVacanceFermetureRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\VacanceFermetureRepository' shared autowired service.
     *
     * @return \App\Repository\VacanceFermetureRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'VacanceFermetureRepository.php';

        return $container->privates['App\\Repository\\VacanceFermetureRepository'] = new \App\Repository\VacanceFermetureRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
